...
void kernelP_heat_3d0(int tsteps,
		      int n,
		      DATA_TYPE POLYBENCH_3D(A,N,N,N,n,n,n),
		      DATA_TYPE POLYBENCH_3D(B,N,N,N,n,n,n))
{
...
void kernelP_heat_3d1(int tsteps,
		      int n,
		      DATA_TYPE POLYBENCH_3D(A,N,N,N,n,n,n),
		      DATA_TYPE POLYBENCH_3D(B,N,N,N,n,n,n))
{
...
int main(int argc, char** argv)
{
  ...
  int t;
  for (t = 1; t <= TSTEPS; t++) {
	kernelP_heat_3d0 (tsteps, n, POLYBENCH_ARRAY(A), POLYBENCH_ARRAY(B));
	kernelP_heat_3d1 (tsteps, n, POLYBENCH_ARRAY(A), POLYBENCH_ARRAY(B));
  }
